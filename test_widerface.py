...
import cv2
from RetinaFace.rcnn.logger import logger
#from rcnn.config import config, default, generate_config
#from rcnn.tools.test_rcnn import test_rcnn
#from rcnn.tools.test_rpn import test_rpn
from RetinaFace.rcnn.processing.bbox_transform import nonlinear_pred, clip_boxes, landmark_pred
from RetinaFace.rcnn.processing.generate_anchor import generate_anchors_fpn, anchors_plane
from RetinaFace.rcnn.processing.nms import gpu_nms_wrapper
from RetinaFace.rcnn.processing.bbox_transform import bbox_overlaps
from RetinaFace.rcnn.dataset import retinaface
...
def parse_args():
    ...
    parser.add_argument('--dataset-path', help='dataset path', default='/home/yeluyue/yeluyue/DataSet/lfw/all/lfw_sor', type=str)
    parser.add_argument('--gpu', help='GPU device to test with', default=0, type=int)
    # testing
    parser.add_argument('--prefix', help='model to test with', default='/home/yeluyue/dl/Datasets/ICCV_challenge/insightface-master/models/retinaface-R50/R50', type=str)
